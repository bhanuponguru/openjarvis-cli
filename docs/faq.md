...
Yes, OpenJarvis is free and open-source under the Apache 2.0 license. If you connect it to local inference servers like Ollama, there are zero subscription or API costs. If you connect it to cloud APIs (OpenAI, Groq, OpenRouter), you only pay standard usage rates to those providers.
